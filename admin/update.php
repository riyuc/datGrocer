...
<?php
  ...
  if(isSet($_POST['ok'])){
    ...
    $sql="update `product` set pID=$pID, category='$category',pName='$pName',pPrice='$pPrice',pQuant='$pQuant',image='$dst1',pDesc='$pDesc' where pID='$pID'" ;
        ...
        <div class="container">
            ...
            <div class="login">
                ...
                <form action="" id="loginForum" method="post" enctype="multipart/form-data">
                    ...
                    <p>
                      <a>
                        <input type = "submit" value = "Update Product" name="ok" class="myBtn logBtn"/>
                      </a>
                    </p>
                </form>
            </div>
